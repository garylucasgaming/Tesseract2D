...
public class Builder : ContentBuilder
{
    ...
    public override IContentCollection GetContentCollection()
    {
        ...
        */
        ...
        contentCollection.Include<WildcardRule>(_projectRoot + "/Assets/*");

        //exclude
        contentCollection.Exclude<WildcardRule>("Assets/**/.git/**/*");
        contentCollection.Exclude<WildcardRule>("Assets/**/.DS_Store");
        contentCollection.Exclude<WildcardRule>("Assets/Temp/**/*");

        // include
        contentCollection.IncludeCopy<WildcardRule>("Assets/**/*.json");
        contentCollection.IncludeCopy<WildcardRule>("Assets/**/*.yaml");
